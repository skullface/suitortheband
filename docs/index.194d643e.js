...
})({"6HNBl":[function(require,module,exports) {
...
function wrapEveryOtherLetter() {
    ...
    headings.forEach((heading)=>{
        ...
        for(let i = 0; i < text.length; i++){
            if (i % 3 === 2) newContent += `<span class='n3'>${text[i]}</span>`;
            else if (i % 3 === 1) newContent += `<span class='n2'>${text[i]}</span>`;
            else newContent += `<span class='n1'>${text[i]}</span>`;
        }
...
},{}]},["6HNBl","bNKaB"], "bNKaB", "parcelRequire2dce")
